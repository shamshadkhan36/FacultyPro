...
export const MeetTheExperts = ({ onSelectFaculty }) => {
  ...
  const institutions = [
    'MIT physicists & theorists',
    'Stanford AI researchers',
    'Harvard medical faculty',
    'Oxford & Columbia legal scholars',
    'Caltech aerospace engineers',
    'Johns Hopkins clinical specialists'
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Experts join FacultyPro from some of the world's most trusted academic and scientific institutions, including:
            </p>

            {/* Checklist matching Screenshot 3 */}
            ...
            <div className="pt-2">
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/90 text-xs text-slate-600 space-y-1">
                <div className="font-bold text-slate-800 flex items-center gap-1.5">
                  ...
                  <span>Triple-Tier Verification Guarantee</span>
                </div>
                <p className="text-[11px] text-slate-500">
                  Identity, doctoral diploma, and active research credentials are authenticated before answering questions.
                </p>
              </div>
            </div>
          ...
          {/* Right Column: Expert Cards Grid matching Screenshot 3 */}
              ...
              {visibleFaculties.map((fac) => (
                ...
                >
                  <div className="space-y-3">
                    ...
                    {/* Circular Avatar and Name & Stars matching Screenshot 3 */}
                    ...
                    {/* Field / Role Title matching Screenshot 3 */}
                  ...
                  {/* Emerald green count matching Screenshot 3 */}
                  <div className="pt-3 border-t border-slate-100 space-y-3">
                    ...
                    >
                      <span>Ask {fac.name.split(' ')[0]} {fac.name.split(' ')[1]}</span>
