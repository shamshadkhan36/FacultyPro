      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
            Popular questions at Faculty<span className="text-[#f05423]">Pro</span>
          </h2>
          <p className="text-sm sm:text-base text-slate-600 mt-2.5 font-normal">
            Real problems solved with point-to-point step-by-step clarity by verified professors.
          </p>
        </div>
            ...
            >
              <div className="p-6 space-y-3">
                ...
                <div className="pt-2 flex items-center gap-1.5 text-[11px] font-semibold text-slate-500">
                  ...
                  <span>Answered by {q.facultyName.split(',')[0]}</span>
                </div>
              </div>

              {/* Bottom Image Container matching Screenshot 2 */}
